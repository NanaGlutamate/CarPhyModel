...
namespace comm
{
	...
	double Comm::Atmos() //大气吸收模型
	{
		...
		double eN;
		//氧气的谐振频率
		std::unordered_map<int, std::pair<double, double>> fN = {{1, {56.2648, 118.7507}}, {3, {58.4466, 62.4863}}, {5, {59.5910, 60.3601}}, {7, {60.4348, 59.1642}}, {9, {61.1506, 58.3239}}, {11, {61.8002, 57.6125}}, {13, {62.4112, 56.9682}}, {15, {62.9980, 56.3634}}, {17, {63.5685, 55.7839}}, {19, {64.1272, 55.2214}}, {21, {64.6779, 54.6728}}, {23, {65.2204, 54.1294}}};
		//电磁波频率
		double f = std::any_cast<double>(rec_para_.ToValueMap()["Comm_Set_Freq"]);
		double gh;
		if (std::any_cast<double>(position_.ToValueMap()["z"]) <= 8)
			gh = 0.640;
		else
			gh = 0.3026 + 0.04218 * std::any_cast<double>(position_.ToValueMap()["z"]);
